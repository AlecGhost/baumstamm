...
pub fn get_person_indices(
    ...
    get_person_indices_with_relationship_layers(
        person_layers,
        &relationship_layers,
        relationships,
        row_length,
...
pub(super) fn get_person_indices_with_relationship_layers(
    person_layers: &Grid<Pid>,
    ...
    match layout_algorithm {
        ...
        LayoutAlgorithm::ForceDirected => get_force_directed_person_indices(
            person_layers,
            relationship_layers,
            relationships,
            row_length,
...
/// Reconstruct relationship layers for direct callers and unit tests. Grid
/// generation passes the graph's authoritative layers instead.
#[cfg(test)]
...
mod tests {
    ...
    fn small_layouts_are_solved_to_global_optimality() {
        ...
        let attractions = attractions(&relationship_layers, &relationships);
        let indices =
            get_person_indices(&layers, &relationships, 6, LayoutAlgorithm::ForceDirected);
    ...
    fn three_slot_move_escapes_a_swap_local_minimum() {
        ...
        let mut indices = get_centered_person_indices(&layers, 6);
    ...
    fn repeated_person_occurrences_are_scored_separately() {
        ...
        let attractions = attractions(&relationship_layers, &relationships);
        let indices = get_person_indices_with_relationship_layers(
            &person_layers,
            &relationship_layers,
            &relationships,
            2,
    ...
    fn got_large_layout_is_stable_under_collective_generation_shifts() {
        ...
        let mut indices = get_person_indices_with_relationship_layers(
            &person_layers,
            &relationship_layers,
            relationships,
            row_length,
